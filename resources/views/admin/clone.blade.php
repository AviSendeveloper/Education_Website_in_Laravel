                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                @endif
                                    <div class="card-body card-block">
                                        <form action="/clone-submit" method="post"  class="form-horizontal" enctype="multipart/form-data">
                                            @csrf
                          ...
                          cogat
                           ...
                           STEM
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="password-input" class=" form-control-label">Meta Title</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="password-input" value="{{ $data['meta_title'] }}" name="meta_title" placeholder="Password" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="password-input" value="{{ $data['meta_description'] }}" name="meta_description" placeholder="Password" class="form-control">
                                                    
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="password-input" class=" form-control-label">Meta Keyword</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="password-input" value="{{ $data['meta_keyword'] }}" name="meta_keyword" placeholder="Password" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="textarea-input" class=" form-control-label">Answer Upload</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                    ...
                                    <div class="card-footer">
                                       ...
                                       <a href="/add-subject" class="btn btn-danger btn-sm">
